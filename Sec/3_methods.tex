...
\begin{figure}[H] % Use: \begin{figure*}[t] to span two columns
    \centering
...
\begin{equation} % Use: \begin{equation*}[t] to span two columns
    e = mc^2
    \label{eq:equation} 
\end{equation}
...
\begin{listing}[H] % Use: \begin{listing*}[t] to span two columns
    \begin{minted}{python}
        def hello():
            print("Hello World!")
    \end{minted}
